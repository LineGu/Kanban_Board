...
export const loginPageController = {
  init() {
    ...
    this.googleLoginButtonElem = document.querySelector('#google');
    this.kakaoLoginButtonElem = document.querySelector('#kakao');
    ...
    this.attachLoginWithGoogleHandler();
    this.attachLoginWithKakaoHandler();
  },
